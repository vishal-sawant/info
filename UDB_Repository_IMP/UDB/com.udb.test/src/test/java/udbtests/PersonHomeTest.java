...
public class PersonHomeTest extends LaunchBrowser {
	...
	public void verifyDefaultNumberOfRecordsDispOnPersonHp(){
		Assert.assertEquals(person.getNumberOfRecordsDisplayedOnPersonHp(), 10, "Not 10 records are displayed per page");
	...
	public void verifyRecordsDisplayedAsPerSelValInDropdown(){
		Assert.assertTrue(person.adjustNumberOfRecordsToBeDisplayedOnPersonHp(),"Incorrect number of records displayed on Person home page");
