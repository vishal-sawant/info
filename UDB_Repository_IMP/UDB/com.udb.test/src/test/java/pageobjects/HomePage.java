...
public class HomePage {
	...
	public AdminRoleGroup clickOnAdminRoleGroup() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(text(), 'Admin')]")));
		commonObj.click("adminBtn");
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(), 'Role Group')]")));
