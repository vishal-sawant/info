...
public class CompanyHomeTest extends LaunchBrowser {
	...
	@Test(priority=7)
	public void verifyCompNameWithNumericData(){
		Assert.assertTrue(company.compNmUsingNumericData(),"Numeric data does not get process properly for Company Name text field");	
		logger.info("Test case passed: verify numeric data entered into Company Name text field process properly");
		Reporter.log("Test case passed: verify numeric data entered into Company Name text field process properly");
	}
