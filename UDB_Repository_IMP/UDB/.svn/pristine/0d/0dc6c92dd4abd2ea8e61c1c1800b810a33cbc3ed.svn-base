...
public class MergerAcquisitionHomeTest extends LaunchBrowser {
	...
	public void verifyMAHomePgDisplayed() {
		...
		Assert.assertTrue(
				mergerAcquisitionHome.getMaHPageText().contains("Target"),
	...
	public void verifyMaHomePageNavigation(String recordsToDisplay) {
		Assert.assertTrue(
	...
	public void verifySearchOnMaHp(String searchByType) {
		Assert.assertTrue(
